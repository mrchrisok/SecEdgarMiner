...
namespace SecEdgarMiner.Logging
{
   ...
   {
	  public static string Form4InsiderBuyingFoundInIssuer(Form4InfoModel form4Info)
	  {
	  ...
	  public static string Form4InsiderBuyingShortAlert(Form4InfoModel form4Info, InsiderBuyingAlertType alertType)
	  {
	  ...
	  public static string Form4InsiderBuyingShortAlertFile(Form4InfoModel form4Info)
	  {
		 return $"{form4Info.IssuerTradingSymbol}, {form4Info.HtmlUrl}";
	  }
	  public static string Form4InsiderBuyingShortAlertEmail(Form4InfoModel form4Info)
	  {
